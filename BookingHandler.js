...
client.on('connect', function() {
    ...
    client.subscribe('/Team5/Dentistimo/Book', function (err) {
        if (!err) {
            client.on('message', function (topic, message) {
                ...
                client.publish('/Team5/Dentistimo/BookingStatus', newBooking.toString(), {qos:0} ) //TODO: This has to be changed into the response from the DB eventually
            } )
        }
    })
})