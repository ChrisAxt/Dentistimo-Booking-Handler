...
const options = {
    clientId:'Dentistimo Team5 - Booking Handler n°' + Math.random().toString(16).substr(2, 8),
    will: {
        topic: "Team5/Dentistimo/BookingHandler/LastWill",
        payload: "Booking handler has been disconnected from the system",
        qos: 1
    }
}
